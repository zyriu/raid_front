    ...
    <div className="bg-primary-dark w-screen h-full mt-0 p-20">
      ...
      <div className="flex flex-col z-20 relative text-white w-full h-screen">
        ...
        {selectedExtracts.length ? (
          ...
          <div className="e=w-full text-center">No resource selected</div>
        )}
        <div className="mx-auto text-2xl mt-20">Available resources :</div>
        <SearchListings items={[]} onItemClick={onItemClick} />
      </div>
    </div>
  );
};
