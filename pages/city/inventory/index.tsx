    ...
    <div className="bg-primary-dark w-screen h-full mt-0 p-20">
      ...
      <div className="grid grid-cols-2 z-20 relative text-white w-full h-screen p-20">
        <Link href="/marketplace">
          <span className="cursor-pointer text-2xl">Buy / Sell items</span>
        </Link>
        <Link href="/city/inventory/craft-item">
          <span className="cursor-pointer text-2xl">Craft items from recipe</span>
        </Link>
      </div>
    </div>
  );
