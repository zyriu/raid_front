...
const Mint: NextPage = () => {
  ...
  const item = useSelector((state: any) => state.marketplace.selectedItem) as Character;
          ...
          <div className="w-full  mr-20 relative flex flex-col">
            ...
            <div className="flex flex-no-wrap mt-4">
              ...
              <Link href="/city/dna-splice/extract">
                <div className="bg-green-600 p-4 text-white ml-4 cursor-pointer">Extract DNA</div>
              </Link>
            </div>
          </div>
