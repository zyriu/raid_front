...
const LevelUp: NextPage = () => {
  ...
  const item = useSelector((state: RootState) => state.marketplace.characters[0]) as Character;
    ...
    <div className="bg-primary-dark w-screen h-full mt-0">
      ...
      <div className="p-20">
        ...
        <div className="p-20 flex w-full">
          {fail ? (
            <div className="h-screen text-3xl text-white">Sorry, your quest failed this time !</div>
          ) : (
            <>
              <div className="w-full  mr-20 relative flex flex-col">
                <div className="flex flex-row relative">
                  <div className="text-white text-3xl absolute -top-5 pr-4 font-bold bg-primary-dark">
                    Nice job, you level up !
                  </div>
                  ...
                  {item.stats.map((stat, index) => (
                    <div className="flex flex-row justify-between" key={index}>
                      ...
                      <ProgressBar
                        ...
                        additional={Math.ceil(Math.random() * 40)}
                      />
                    </div>
                  ))}
                </div>
